...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx1bb04643f149146c',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '534d15f9d8a7465a19d66bd68fb18091',
  ...
  USERS: [
    {
      ...
      id: 'o676s6YXc6bMuqab-tRCQJw9oxtg','o676s6Ro9tUJ8OUihtxLKf_OP_xk'
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '',
      // 所在省份
      province: '广东',
  ...
  CALLBACK_TEMPLATE_ID: 'LJrEwy1xCcEAhHSU6sSoDMbmaQSAgVjfC4ofXFp-ggk',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'o676s6Ro9tUJ8OUihtxLKf_OP_xk',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
